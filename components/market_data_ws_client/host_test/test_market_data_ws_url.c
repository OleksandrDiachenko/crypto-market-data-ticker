...
static void test_single_symbol_lowercased(void)
{
    ...
    market_data_err_t err =
        market_data_ws_url_build_combined_stream("wss://stream.binance.com:9443", symbols, 1, "kline_1s", out,
                                                  sizeof(out));
...
static void test_multiple_symbols_joined_in_order(void)
{
    ...
    char out[160];
    market_data_err_t err =
        market_data_ws_url_build_combined_stream("wss://stream.binance.com:9443", symbols, 3, "kline_1s", out,
                                                  sizeof(out));
    CHECK(err == MARKET_DATA_OK);
